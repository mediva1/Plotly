...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    let sampleIds = samplesArray.filter(sampleData => sampleData.id == sample);
    ...
    var barLayout = {
      ...
      xaxis: {title: "<b>Bacteria Sample Values</b>"},
      width: 700, 
      height: 360, 
      margin: {t: 80, l: 100, b: 100}
    };
    ...
    var bubbleLayout = {
      title: "<b>Bacteria Cultures</b><br><i>Per Sample</i>",
      xaxis: {
        title: "<b><i>OTU ID</i></b>", 
        automargin: true
      },
    ...
    let metadataArray = metadata.filter(sampleData => sampleData.id == sample);
